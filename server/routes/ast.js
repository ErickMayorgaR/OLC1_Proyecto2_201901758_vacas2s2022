...
const Graph = require('../controller/AST/Graph');
...
module.exports = (parser, app) => {
    app.post('/AST_report', (req, res) => {
        try {
            ...
            //const filepath = path.join('C:/Users/Public/BlueStacks/grafica')
            const filepath = path.join('C:/Users/emayo/Desktop//grafica')
